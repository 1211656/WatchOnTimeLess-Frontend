            ...
            <div className='     h-28'>
              <div className='    flex  justify-between '>
                ...
                <div className='flex items-center gap-2 text-green  absolute centerRight '>
                  ...
                  <button onClick={() => { navigate("/aboutus") }} className=' items-center uppercase text-white mr-2  mt-1' style={{ color: cor === 'black' ? 'black' : 'white' }}>
                    Ajuda
                  </button>
                  <button onClick={() => { navigate("/cesto") }} className=' items-center uppercase text-white mr-2  mt-1' style={{ color: cor === 'black' ? 'black' : 'white' }}>
                    Cesto(0)
                  </button>
                </div>
